<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:113:"/Users/xiaohe/Documents/job/fastadmin/1.0.0.20181031_full/public/../application/admin/view/user/delivery/add.html";i:1546438873;s:100:"/Users/xiaohe/Documents/job/fastadmin/1.0.0.20181031_full/application/admin/view/layout/default.html";i:1540985180;s:97:"/Users/xiaohe/Documents/job/fastadmin/1.0.0.20181031_full/application/admin/view/common/meta.html";i:1540985180;s:99:"/Users/xiaohe/Documents/job/fastadmin/1.0.0.20181031_full/application/admin/view/common/script.html";i:1540985180;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Head_pic'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-head_pic" class="form-control" name="row[head_pic]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-state" data-rule="required" class="form-control" name="row[state]" type="number" value="2">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Work_state'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-work_state" data-rule="required" class="form-control" name="row[work_state]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Wallet'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-wallet" data-rule="required" class="form-control" name="row[wallet]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
