define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'd/user/delivery/index',
                    add_url: 'd/user/delivery/add',
                    edit_url: 'd/user/delivery/edit',
                    del_url: 'd/user/delivery/del',
                    multi_url: 'd/user/delivery/multi',
                    table: 'd_user_delivery',
                }
            });
